...
`;
export class NetStatsIcon extends React.PureComponent {
    render() {
        return React.createElement(SvgIconEncoded, { size: this.props.size }, getIconSvg(this.props.color));
    }
}
//# sourceMappingURL=NetStatsIcon.js.map