 ...
 */
export function scrollElementToY(container, newScrollTop, durationMillis, cancellationToken) {
    ...
    return new Promise((resolve, reject) => {
        let step = () => {
            ...
            let deltaScroll = Math.min(totalScrollAmount * elapsedTime / durationMillis, totalScrollAmount - scrolledAmount);
